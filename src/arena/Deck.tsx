    ...
    >
      ...
      {rightClickedCard && panelPosition ? (
        <ConnectionsPanelHost
          ...
          author={(rightClickedCard as any)?.user ? { id: (rightClickedCard as any).user.id, username: (rightClickedCard as any).user.username, full_name: (rightClickedCard as any).user.full_name, avatar: (rightClickedCard as any).user.avatar } : undefined}
